...
StackChanBoard::ServoTorqueResult StackChanBoard::InternalSetServoTorque(bool yaw_enabled, bool pitch_enabled, ReleaseReason reason, uint32_t expected_release_epoch) {
